...
set "OUT_EXE=%SCRIPT_DIR%dist\Eche-Installer.exe"
set "SPEC=%SCRIPT_DIR%build.spec"

echo.
echo  ========================================
echo   ECHE INSTALLER - BUILD
echo  ========================================
echo.

REM --- Find Python (prefer eche_source\.venv) ---
set "PY="
if exist "%WORKSPACE%\eche_source\.venv\Scripts\python.exe" (
  set "PY=%WORKSPACE%\eche_source\.venv\Scripts\python.exe"
  echo [INFO] Python: eche_source\.venv
) else if exist "%SCRIPT_DIR%.venv\Scripts\python.exe" (
  set "PY=%SCRIPT_DIR%.venv\Scripts\python.exe"
  echo [INFO] Python: eche_installer\.venv
) else (
...
echo   Also: final\Eche-Installer.exe
echo.
