...
Eche does **not** invent answers by itself — it sends a message over the internet
...
| Eche | The robot that listens and posts |
...
Eche ships pointed at **Groq** because it is fast and has a free tier.
