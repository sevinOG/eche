...
# 2) Optional legacy alias: echelon_ecosystem.* → * (older frozen builds only).
import os
import sys
...
# Keep frozen builds that still reference echelon_ecosystem.* working
# until the next install.bat rebuild. Source code no longer uses this prefix.
_LEGACY_PREFIX = "echelon_ecosystem."
