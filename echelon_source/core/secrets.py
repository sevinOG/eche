# core/secrets.py
# Standard local secret handling for Echelon.
#
...
ENV_MAP = {
    ...
    "provider_backend": "ECHELON_PROVIDER",
...
def _dpapi_protect(data: bytes, description: str = "Echelon secret") -> bytes:
...
def _save_encrypted_secrets(root: str, secrets: dict[str, str]) -> None:
    payload = {
        "version": 1,
        "note": "DPAPI-encrypted secrets for Echelon. Not portable across Windows users/machines.",
        "secrets": {},
    }
    for key in SECRET_KEYS:
